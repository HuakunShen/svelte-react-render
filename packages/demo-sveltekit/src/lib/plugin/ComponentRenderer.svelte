...
{:else if ['div', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'span', 'p', 'strong', 'em', 'b', 'i', 'a', 'ul', 'ol', 'li', 'section', 'article', 'header', 'footer', 'main', 'label', 'br', 'hr'].includes(instance.type)}
	...
	<svelte:element this={instance.type} {...htmlProps}>
...
{:else if instance.type === 'Button'}
	...
	{@const buttonProps = {
		...
		onClick:
			instance.props.onClick || createHandlerFromId(instance.props._onClickHandlerId, 'onClick'),
...
{:else if instance.type === 'Input'}
	{@const inputProps = {
		...
		onInput:
			instance.props.onInput || createHandlerFromId(instance.props._onInputHandlerId, 'onInput'),
		onChange:
			instance.props.onChange || createHandlerFromId(instance.props._onChangeHandlerId, 'onChange')
	}}
	<Input {...inputProps} />
...
{:else if instance.type === 'FormLabel'}
	...
	<label
		class={instance.props.className ||
